...
describe('CostCalculator', () => {
  ...
  it('falls back cleanly for Claude Console alias models when detailed pricing is missing', () => {
    pricingService.calculateCost.mockReturnValue({
      hasPricing: false,
      totalCost: 0,
      isLongContextRequest: false
  ...
  it('uses priority pricing when serviceTier is priority and model supports it', () => {
    pricingService.getModelPricing.mockReturnValue({
    ...
    expect(priority.debug.usedFallbackPricing).toBe(false)
  })
})
